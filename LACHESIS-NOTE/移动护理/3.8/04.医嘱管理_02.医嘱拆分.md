...
如何判断是长期医嘱和临时医嘱呢？见[[04.医嘱管理_01.基础知识#医嘱类型]]
...
* 第二部分：拆分条件
	...
	* 条件2：医嘱类型（对应的就是原始医嘱上医嘱类别字段，见[[04.医嘱管理_01.基础知识#医嘱概念#医嘱类别]]）
	* 条件3：是否为静配药品
* 第三部分：拆分时机
	* 定时任务拆分
	* 打印瓶签时拆分
...
当医院要求<font color="#ff0000">首末日（第一天/最后一天）</font>拆分需要按照特定的时间拆分时，则需要在对应的类型中的首末日拆分规则中选择 按开立次数适配频次拆分， 并且需要在首末日拆分中绑定指定的拆分频次。
...
![[04.医嘱管理_02.医嘱拆分_拆分配置.excalidraw|L|1200]]


# 拆分场景

![[04.医嘱管理_02.医嘱拆分_触发时机.excalidraw|L|1000]]
