...
use mnis
db.htmlToPdfLog.find({inhosCode:'2025-07269297-0',templateCode:''}).sort({ submitTime: -1 })
...
文书归档表：windranger_mnis.doc_data_filing_record
...
```sql
select * from windranger_mnis.doc_data_evaluate_header where inhos_code = '000991984700' and template_code = 'T000193'
select * from windranger_mnis.doc_data_evaluate_header_detail where inhos_code = '000991984700' and header_code = 'H00020512'

select * from windranger_mnis.doc_data_filing_record where status = '2'
select * from windranger_mnis.doc_data_filing_record where inhos_code = '001014039300' and status = '2'
select * from windranger_emr.pat_inhos_record where inhos_code = '001014039300'
```